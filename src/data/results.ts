...
export const resultTypes: Record<string, ResultType> = {
  shark: {
    ...
    title: "3발 상어형",
    emoji: "🦈",
    description: "혼돈 그 자체. 예측 불가능한 사고 방식의 소유자입니다. 당신의 뇌는 상어처럼 끊임없이 움직이며 아무도 예상하지 못한 방향으로 헤엄칩니다.",
    characteristics: [
  ...
  frog: {
    ...
    title: "개굴브레인형",
    emoji: "🐸",
    description: "뇌가 개구리처럼 점프! 신박한 유머 감각의 끝판왕입니다. 당신의 사고는 개구리처럼 이리저리 뛰어다니며 독특한 관점을 제시합니다.",
    characteristics: [
  ...
  tts: {
    ...
    title: "TTS 중독형",
    emoji: "🐤",
    description: "음성합성 밈에 과몰입한 AI 친화형입니다. 당신은 로봇 목소리로 말하는 것을 즐기며, 일상 대화에도 TTS 스타일을 적용합니다.",
    characteristics: [
    ...
    imageUrl: "/images/tts.png"
  },
  circuit: {
    id: "circuit",
    title: "회로터짐형",
    emoji: "🤖",
    description: "논리적이지만 브레인터지는 말장난을 즐깁니다. 당신의 뇌는 마치 복잡한 회로처럼 작동하며, 때로는 과부하로 터져버립니다.",
    characteristics: [
      "논리적인 사고방식을 가지고 있습니다",
    ...
    imageUrl: "/images/circuit.png"
  },
  serious: {
    id: "serious",
    title: "의외의 진지충형",
    emoji: "🪿",
    description: "겉은 밈충, 속은 진중. 반전 매력의 소유자입니다. 당신은 유머 뒤에 진지함을 숨기고 있는 이중적 캐릭터입니다.",
    characteristics: [
    ...
    imageUrl: "/images/serious.png"
  },
  analyst: {
    id: "analyst",
    title: "무의미 분석가형",
    emoji: "🐍",
    description: "무의미 속 의미를 찾고자 하는 철학자형 캐릭터입니다. 당신은 밈과 유행어 속에서도 깊은 의미를 발견하려 노력합니다.",
    characteristics: [
